...
const SessionExpiredModal = props => {
  ...
  return(
    <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingBottom: 20 }}>
      ...
      <Text style={{ margin: 5, fontSize: 22, fontWeight: 'bold', color: 'white', marginTop: 30 }}>SessionExpired</Text>
      <Text style={{ margin: 5, fontSize: 18, fontWeight: 'bold', color: 'white', textAlign: 'center', marginTop: 20 }}>This session is no longer valid.</Text>
      <Text style={{ margin: 5, fontSize: 18, fontWeight: 'bold', color: 'white', textAlign: 'center', marginTop: 20 }}>Press OK to continue</Text>
